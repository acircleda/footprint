test_that("airport_footprint() works", {
  ...
  expect_equal(airport_footprint("LAX", "PUS", output="n20"), 9.336, tolerance = tol)
  ...
  expect_equal(latlong_footprint(34.052235, -118.243683, 35.179554, 129.075638), 1881.589, tolerance = tol)
  expect_type(latlong_footprint(34.052235, -118.243683, 35.179554, 129.075638), "double")
